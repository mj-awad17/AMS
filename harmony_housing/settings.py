"""
Django settings for harmony_housing project.
"""
...
ROOT_URLCONF = 'harmony_housing.urls'
...
WSGI_APPLICATION = 'harmony_housing.wsgi.application'
...
if USE_SUPABASE:
    ...
    # Using pooler for better connection stability and performance
    DATABASES = {
        'default': {
            'ENGINE': 'django.db.backends.postgresql',
            'NAME': env('DB_NAME', default='postgres'),
            'USER': env('DB_USER', default='postgres.ofytgjjxhnmluqhpejws'),
            'PASSWORD': env('DB_PASSWORD', default=''),
            'HOST': env('DB_HOST', default='aws-1-ap-south-1.pooler.supabase.com'),
            'PORT': env('DB_PORT', default='6543'),  # Transaction Pooler port
            'OPTIONS': {
                'connect_timeout': 10,
                'options': '-c statement_timeout=30000',  # 30 second timeout
            },
            'CONN_MAX_AGE': 0,  # Important for pooler: don't persist connections
        }
    }
else:
...
# Custom User Model
AUTH_USER_MODEL = 'accommodation.User'
